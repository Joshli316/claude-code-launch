...
const strings = {
  ...
  badge_first_lesson:  { zh: '第一课完成', en: 'First Lesson Done' },
  badge_first_quiz:    { zh: '首次通关', en: 'First Quiz Passed' },
  badge_streak_3:      { zh: '三天连续', en: '3-Day Streak' },
  badge_streak_7:      { zh: '一周坚持', en: '7-Day Streak' },
  badge_html_done:     { zh: 'HTML毕业', en: 'HTML Graduate' },
  badge_css_done:      { zh: 'CSS达人', en: 'CSS Master' },
  badge_js_done:       { zh: 'JS入门', en: 'JS Starter' },
  badge_deploy:        { zh: '成功部署', en: 'First Deploy' },
  badge_all_complete:  { zh: '全部通关', en: 'All Complete' },
